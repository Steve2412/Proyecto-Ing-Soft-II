...
-- Date: Mon, 24 Jul 2023 00:19:10 +0200
...
SET autocommit=0;
INSERT INTO `notifipago` VALUES (1,20,'Venezolano de Credito','26875009','2023-07-12',73473284,'Pago Ingles I','V-28409157','Procesado'),(2,15,'Banesco','26875009','2023-07-19',312312,'Pago Ingles II','V-28409157','Procesado'),(4,25.35,'Banco Provincial','V-14896137','2023-07-13',513545511,'Ingles I','V-28409157','Procesado'),(5,17.14,'Bancrecer','V-5456452','2023-07-03',6365654,'Ingles I','V-28409157','Procesado');
/*!40000 ALTER TABLE `notifipago` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `notifipago` with 4 row(s)
--
...
SET autocommit=0;
INSERT INTO `periodo` VALUES ('2020_1','Enero Abril 2022','2001-01-09','2001-04-09','Activo'),('2023_2','Periodo Mayo Agosto 2023','2023-05-01','2023-08-01','Activo'),('2023_3','Enero Abril 2023','2023-01-09','2023-04-15','Activo');
...
SET autocommit=0;
INSERT INTO `usuario` VALUES ('V-10214983','Jaime','Acosta','JaimeAcosta@yahoo.es','Admin2023.','Campo Claro','0416-7813428','1990-07-04','M','Eliminado'),('V-15241968','Delia','Rubio','DeliaRubio@gmail.com','Delia12345','Merida','0412-6974158','1982-04-05','F','Activo'),('V-18146752','Placido ','Sacristan','PlacidoSacristan@gmail.com','Placido1234','Caracas','0412-5874169','1982-10-21','M','Activo'),('V-28409157','Stefano','Casa','Stefano007Casa@hotmail.com','Prueba2001.','Palaima','0414-9664100','2001-12-24','M','Activo'),('V-8032002','Jose','Rodriguez','JoseRodriguez@gmail.com','Profesor2001.','Bella Vista','0412-6987425','1983-04-13','M','Activo');
...
SET autocommit=0;
INSERT INTO `usuario_has_cursos` VALUES ('V-28409157','Eng_I_A','2023_2',20,'Estudiante','Activo'),('V-8032002','Eng_I_A','2023_2',0,'Profesor','Activo'),('V-10214983',NULL,NULL,0,'Administrador',NULL),('V-15241968','IT_I_A','2023_2',0,'Estudiante','Activo'),('V-18146752','IT_I_A','2023_2',0,'Profesor','Activo');
/*!40000 ALTER TABLE `usuario_has_cursos` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `usuario_has_cursos` with 5 row(s)
--
...
-- Dump completed on: Mon, 24 Jul 2023 00:19:10 +0200
